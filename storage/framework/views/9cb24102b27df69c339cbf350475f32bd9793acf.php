<?php $__env->startPush('css'); ?>
 <link href="<?php echo e(URL::asset('assets/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css')); ?>" rel="stylesheet" />
  <style>
#canvas{
width:100%;
}
                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          <div class="text-center round">
                              <a href="">
                                <img src="./images/logo/<?php echo e($usr->logo); ?>" id="img" alt="">
                              </a>
                                
                              <h4 style="color: #41cac0;"><?php echo e($usr->name); ?></h4>
                              <p><?php echo e($usr->email); ?></p>
                          </div>
                  ...
                  <aside class="profile-info col-lg-9">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <div class="row">
                                  <div class="bio-row">
                                      <p><label>Company Name</label> : <?php echo e($usr->name); ?></p>
                                  </div>
                                  ...
                                  <div class="bio-row">
                                      <p><label>GST CODE </label> : <?php echo e($usr->gst); ?></p>
                                  </div>
                                  <div class="bio-row">
                                      <p><label>Email </label> : <?php echo e($usr->email); ?></p>
                                  </div>
                                  <div class="bio-row">
                                      <p><label>Mobile </label> : <?php echo e($usr->mobile); ?></p>
                                  </div>
                                  <div class="bio-row">
                                      <p><label>Address </label> : <?php echo e($usr->address); ?></p>
                                  </div>
                              </div>
                          </div>
                      </section>
                          ...
                          <div class="panel-body ">
                              <div class="chart">
                                  <div class="heading">
                                      ...
                                      <strong>Invoice : Rs. <?php echo e($todayinvoice->invoicesum); ?> | Payment : Rs. <?php echo e($todaypayment->paymentsum); ?></strong>
                                  </div>
...
<div class="panel terques-chart ipchart">
                          <div class="panel-body ">
                              <div class="chart">
                                  <div class="heading">
                                      <span><?php echo date('l'); ?></span>
                                      <strong>Expense : Rs. <?php echo e($todayexpense->expensesum); ?></strong>
                                  </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('js/allfunctions.js')); ?>"></script>
    <!--common script for all pages-->
   
    <script src="<?php echo e(URL::asset('assets/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(URL::asset('js/charts.min.js')); ?>"></script>
